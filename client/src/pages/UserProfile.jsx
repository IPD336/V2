  ...
  return (
    <div className="page" style={{ background: 'var(--cream)' }}>
      <div className="container" style={{ maxWidth: 800, paddingTop: 48, paddingBottom: 80 }}>
        ...
        {/* Profile Header */}
        <div style={{ background: 'white', borderRadius: 20, padding: 40, border: '1px solid var(--border)', marginBottom: 24, display: 'flex', gap: 32, alignItems: 'flex-start' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 8 }}>
                  <h1 style={{ fontFamily: 'PT Serif, serif', fontSize: 32, fontWeight: 700, letterSpacing: -0.5, margin: 0 }}>{user.name}</h1>
                ...
                <div style={{ fontSize: 14, color: 'var(--muted)', display: 'flex', gap: 16, marginBottom: 16 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, marginBottom: 32 }}>
          {/* Skills Offered */}
          <div style={{ background: 'white', borderRadius: 20, padding: 32, border: '1px solid var(--border)' }}>
        ...
        {user.languages?.length > 0 && (
           <div style={{ background: 'white', borderRadius: 20, padding: 32, border: '1px solid var(--border)', marginBottom: 32 }}>
        ...
        <div>
          ...
          <h2 style={{ fontFamily: 'PT Serif, serif', fontSize: 24, fontWeight: 600, marginBottom: 24 }}>Reviews ({reviews.length})</h2>
          
          {reviews.length === 0 ? (
            <div className="empty-state" style={{ background: 'white', borderRadius: 20, border: '1px solid var(--border)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {reviews.map((r) => (
                <div key={r._id} style={{ background: 'white', borderRadius: 16, padding: 24, border: '1px solid var(--border)' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      ...
                      <div>
                        <div style={{ fontWeight: 700, fontSize: 14 }}>{r.reviewer?.name}</div>
                  ...
                  {r.feedback && <div style={{ fontSize: 14, lineHeight: 1.6 }}>"{r.feedback}"</div>}
                </div>
              ))}
            </div>
          )}
